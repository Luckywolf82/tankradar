 ...
 * 
 * This file documents the deterministic matching algorithm for pairing external
 * observations (prices, stations) to canonical Station records. It defines inputs,
 * scoring model, thresholds, safety constraints, and test cases.
 * 
 * ═══════════════════════════════════════════════════════════════════════════════
 * 1. MATCHING INPUTS
 * ═══════════════════════════════════════════════════════════════════════════════
 ...
 *   rawName: string,              // Original name from source ("Circle K Heimdal")
 *   latitude: number,
 *   longitude: number,
 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * Match Score (0–100) = Distance + Chain + Name Similarity + Location + City Bonus
 * 
 ...
 *   - If multiple ≥65, downgrade to review_needed
 * 
 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * - Machine learning refinement of weights (once curator feedback accumulates)
...
// See Phase 2 for implementation as lib/stationMatching.js