{
  ...
  "phase2_matching_engine": {
    "distance_tests": {
      ...
      ">300m": { "signal": 0, "status": "NOT_TESTED_NOT_BLOCKING" }
    },
    "auto_match_gate": {
    ...
    "dominance_gap": { "status": "CONFIRMED_WORKING" },
    "chain_normalization": { "status": "CONFIRMED" },
    "name_similarity": { "status": "CONFIRMED" }
  },
  "catalog_state": {
